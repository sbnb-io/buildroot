...
# Only create /usr/sbin symlink when merged /usr is not enabled.
# With merged /usr, /usr/sbin is a symlink to bin, so this would
# overwrite the actual binary with a circular symlink.
